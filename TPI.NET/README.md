...
Los planes de entrenamiento incluyen distintos **Tipos de Actividad** y tienen un precio definido. El pago de las cuotas asociadas a estos planes se procesa mediante una integración con la **API Sandbox de Mercado Pago**.
...
3. Alta, Baja, Modificaciones y Consulta de Equipamiento (Máquinas y Materiales (esto se podria recortar))
4. Alta, Baja, Modificaciones y Consulta de Profesores 
5. Alta, Baja, Modificaciones y Consulta de Planes y Tipos de Actividad (capaz recortar)
...
## Modelo de Dominio 
<img width="1763" height="997" alt="MD TPI-Gimnasio" src="https://github.com/user-attachments/assets/52d98d33-294a-4609-83d3-ef545a903fce" />
